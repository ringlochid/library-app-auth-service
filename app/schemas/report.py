...
class ReportTarget(BaseModel):
    ...
    action: Literal["CREATE", "UPDATE", "DELETE", "APPROVE", "REJECT", "RECOVER"] = (
        Field(..., description="Type of action being reported")
    )
...
class ReportSubmitRequest(BaseModel):
    ...
    category: Literal["SPAM", "INAPPROPRIATE", "VANDALISM", "COPYRIGHT", "OTHER"] = (
        Field(..., description="Category of abuse")
    )
