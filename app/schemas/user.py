...
class UserCache(BaseModel):
    """
    Complete User model for caching. Mirrors all User columns except hashed_password.
    No computed fields - those are added in UserRead for API responses.

    Only for internal use in caching layer.
    """
    ...
    pending_role_upgrade: dict | None = None
