...
mail_to = os.getenv("MAIL_TEST_TO") or os.getenv("MAIL_TO")


skip_reason = "Mailtrap/SMTP env vars not set; set MAIL_HOST, MAIL_USER, MAIL_PASSWORD, MAIL_FROM, and MAIL_TEST_TO to run integration test."
